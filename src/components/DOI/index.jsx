    ...
    <div className="container">
      <div className="formBox">
        <form>
          ...
          <span className="formHelp">(uvádějte pouze číselnou část DOI, bez http(s)://doi.org/ - např. 10.1038/nature12373)</span><br/>
          <input type="text" id="myDOI" onChange={(event) => {setDoi(event.target.value)}} /><br/>
          <button type="button" onClick={handleOnClick}>Ochytři mě</button>
          <button href="#">Začni nový list!</button>
        </form>
      </div>
